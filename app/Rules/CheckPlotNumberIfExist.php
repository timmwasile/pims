...
class CheckPlotNumberIfExist implements Rule
{
    ...
    {
        $number = Plot::where('map_number', $value)->count();
    ...
    {
        return "The entered plot number " .strtoupper($this->map_number). " has already taken or used" ;
    }
}
