...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('first_name', null, ['class' => 'form-control', 'maxlength' => 120, 'maxlength' => 120]) !!}
</div>

<!-- Last Name Field -->
<div class="form-group col-sm-6">
    {!! Form::label('last_name', 'LastName:') !!}
    {!! Form::text('last_name', null, ['class' => 'form-control', 'maxlength' => 120, 'maxlength' => 120]) !!}
</div>
...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        <select class="form-control select2 {{ $errors->has('genders') ? 'is-invalid' : '' }}" name="genders[]"
            id="roles" required>
