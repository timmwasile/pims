    ...
    >
        <div class="row justify-content-center mb-3">
            <div class="col-12 text-center">
                <h2>{{ __('PLATINUM MEDICAL HOSPITAL CARE') }}</h2>
            </div>
        </div>
                    ...
                    <tbody class="text-uppercase">
                        ...
                        @foreach($deductions as $deduction)
                           <tr>
                                ...
                                <td scope="col">{{ number_format($deduction->amount,2)}}</td>
                            </tr>
                            @php
                            $no++; 
                            @endphp
                        ...
                        @foreach($loans as $loan)
                           <tr>
                                ...
                                <td scope="col">{{ number_format($loan->amount,2)}}</td>
                            </tr>
                            @php
                            $no++; 
                            @endphp
                        @endforeach
                            ...
                            <tr>
                                ...
                                <td>{{ number_format($total_deduction+$total_loan,2)}}</td>
                            </tr>
                    ...
                    <thead class="font-weight-normal font-italic">
                        <tbody class="font-weight-bold">
                         <tr scope="row">
                                ...
                                <td colspan="3">{{ number_format($total_payment-($total_deduction+$total_loan),2)}}</td>
                            </tr>
                        </tbody>
                    </thead>
                </table>
