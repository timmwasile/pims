                ...
                <div class="col-lg-8 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <canvas id="myChart" height="1022" width="1686"
                                style="display: block; height: 511px; width: 843px;"
                            ...
                            <div class="statistic-details mt-sm-4">
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-name">Today's Application</div>
                                </div>
                                <div class="statistic-details-item">
                                    <span class="text-muted"><span class="text-danger"><i
                                                class="fas fa-caret-down"></i></span> 0%</span>
                                    <div class="detail-value">0</div>
                                    <div class="detail-name">This Week's Application</div>
                                </div>
                                <div class="statistic-details-item">
                                    <span class="text-muted"><span class="text-primary"><i
                                                class="fas fa-caret-up"></i></span>0%</span>
                                    <div class="detail-value">0</div>
                                    <div class="detail-name">This Month's Application</div>
                                </div>
                                <div class="statistic-details-item">
                                    <span class="text-muted"><span class="text-primary"><i
                                                class="fas fa-caret-up"></i></span> 0%</span>
                                    <div class="detail-value">0</div>
                                    <div class="detail-name">This Year's Application</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                @foreach ($payments as $id => $payment)
                                    <li class="media">
                                        <img class="mr-3 rounded-circle" width="50"
                                            src="{{ asset('backend/img/logo.png') }}" alt="platinum">
                                        <div class="media-body">
                                            <span class="text-small text-muted">Type: {{ ucwords($payment->name) }}</span>
                                            <div class="media-title"> <span class="text-small text-muted">Description:
                            ...
                            <div class="text-center pt-1 pb-1">
                                <a href="{{ route('admin.payments.index') }}" class="btn btn-primary btn-lg btn-round">
                                    View All
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div id="visitorMap"
                                style="position: relative; overflow: hidden; background-color: rgb(255, 255, 255);"><svg
                                    width="612" height="210">
                                    <g transform="scale(0.38181818181818183) translate(326.4285714285714, 0)">
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_id" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_pg" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_mx" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_ee" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_dz" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_mr" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_ci" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_ml" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_bf" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_ng" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_tn" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_ly" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_eg" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_td" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_et" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_so" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_ye" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_cf" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_st" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_gq" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_ga" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_cg" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_ao" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_ug" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_ke" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_tz" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_zm" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_mw" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_mz" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_zw" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_na" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_gl" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_au" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_sb" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_vu" class="jqvmap-region"></path>
                                        <path
                                            d="M948.62,412.29l-1.24,1.66l-0.1,1.87l1.44,1.46L948.62,412.29L948.62,412.29z"
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_fj" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_ph" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_tw" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_jp" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_ru" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_mg" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_km" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_sc" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd" original="#ddd"
                                            id="jqvmap1_mv" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_cv" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_ht" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_fk" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_is" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_no" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_lk" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_cu" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_bs" class="jqvmap-region"></path>
                                        <path
                                            d="M238.93,279.59l-3.48,0.88v0.97l2.03,1.17h2.13l1.35-1.56L238.93,279.59L238.93,279.59z"
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_jm" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_ec" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_ca" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_gt" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_pa" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_co" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_ve" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_gy" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_sr" class="jqvmap-region"></path>
                                        <path
                                            d="M302.13,321.8l5.85,3.65l-3.06,6.08l-1.11,1.4l-3.25-1.87l0.09-6.55L302.13,321.8L302.13,321.8z"
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_gf" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_pe" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_bo" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_py" class="jqvmap-region"></path>
                                        <path
                                            d="M300.36,431.93l-2.05,2.19l0.85,11.78l6.44,1.87l8.19-8.21L300.36,431.93L300.36,431.93z"
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_uy" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_ar" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_cl" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_kp" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_kr" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_kz" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_tm" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_uz" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_tj" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_kg" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_af" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_pk" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_th" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_kh" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_la" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_az" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_ir" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_tr" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_sa" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_sy" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_iq" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_gb" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_ie" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_se" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_fi" class="jqvmap-region"></path>
                                        <path
                                            d="M518.07,151.37l-6.85-1.11l0.15,3.83l6.35,3.88l2.6-0.76l-0.15-2.92L518.07,151.37L518.07,151.37z"
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_lv" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_lt" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_by" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_pl" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_it" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_fr" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_de" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_dk" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_sk" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_at" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_hu" class="jqvmap-region"></path>
                                        <path
                                            d="M494.8,191.99l-2.54,1.52l-4.74,1.04l0.95,2.74l3.32,0.04l3.06-2.56L494.8,191.99L494.8,191.99z"
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_si" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_ro" class="jqvmap-region"></path>
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_rs" class="jqvmap-region"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                            original="#ddd" id="jqvmap1_gr" class="jqvmap-region"></path>
                                    </g>
                                </svg>
                                <div class="jqvmap-zoomin">+</div>
                                <div class="jqvmap-zoomout">−</div>
                                <div id="jqvmap1_id_pin" for="id" class="jqvmap-pin"
                                    style="position: absolute; left: 419.196px; top: 122.518px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_my_pin" for="my" class="jqvmap-pin"
                                    style="position: absolute; left: 409.571px; top: 114.544px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_th_pin" for="th" class="jqvmap-pin"
                                    style="position: absolute; left: 399.288px; top: 103.049px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_sy_pin" for="sy" class="jqvmap-pin"
                                    style="position: absolute; left: 330.555px; top: 79.3514px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_eg_pin" for="eg" class="jqvmap-pin"
                                    style="position: absolute; left: 323.471px; top: 88.9809px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_ae_pin" for="ae" class="jqvmap-pin"
                                    style="position: absolute; left: 348.144px; top: 91.352px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_nz_pin" for="nz" class="jqvmap-pin"
                                    style="position: absolute; left: 461.819px; top: 184.439px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_tl_pin" for="tl" class="jqvmap-pin"
                                    style="position: absolute; left: 426.495px; top: 132.283px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_ng_pin" for="ng" class="jqvmap-pin"
                                    style="position: absolute; left: 300.964px; top: 109.698px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_si_pin" for="si" class="jqvmap-pin"
                                    style="position: absolute; left: 306.241px; top: 64.9168px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_pa_pin" for="pa" class="jqvmap-pin"
                                    style="position: absolute; left: 205.788px; top: 109.677px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_au_pin" for="au" class="jqvmap-pin"
                                    style="position: absolute; left: 429.446px; top: 160.411px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_ca_pin" for="ca" class="jqvmap-pin"
                                    style="position: absolute; left: 208.772px; top: 32.1988px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                                <div id="jqvmap1_tr_pin" for="tr" class="jqvmap-pin"
                                    style="position: absolute; left: 326.514px; top: 74.1873px;">
                                    <div class="jqvmap-circle"></div>
                                </div>
                            </div>
                        </div>
