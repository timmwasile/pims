    ...
    >
        <div class="row justify-content-center mb-3">
            <div class="col-12 text-center">
                ...
                <h3 style="text-align: center">{{ __('  Transaction Report') }}</h3>
                <h3 style="text-align: center">From :{{$request->started_at  }} to : {{$request->ended_at  }}</h3>
        ...
        <div class="row">
                ...
                <div class="column" >
                    <div class="w3-container  w3-cell">
                       <p>Printed At : <strong> {{ date('y-m-d h:m:sa') }}</strong></p> 
                        <p>Printed By :  <strong>{{ ucwords(auth()->user()->name) }}</strong></p> 
                    </div>
                </div>
                <div class="column">
                   <div class="w3-container  w3-cell">
            ...
            <div class="col-lg-12 col-md-12">
                ...
                <table class="table table-borderless">
                    <thead class="font-weight-normal font-italic">
                        ...
                        <tr  >
                            {{-- <th colspan="5" style="text-align: center">Transaction Payment List</th> --}}
                        </tr>
                        </tbody>
                        <tr>
                    ...
                    <tbody class="text-uppercase">
                        ...
                        @foreach($transactions as $transaction)
                           <tr style="font-size: 12px">
                                ...
                                <td scope="col"  align="center">{{ ucwords($transaction->customer_name) }}</td>
                        ...
                        @endforeach
<tr>
                                <td colspan="5" style="text-align: right">Total Payed:</td>
